...
#Changing the model to sm
# nlp = spacy.load('en_core_web_sm')

#NOTE: I found that the degree of similarity decreased when using the sm model. Almost like it is not filled with enough content to be able to
#fully check similarities
